...
### Principles of collaboration {#principles-of-collaboration}
...
* We defined a set of key initial **phenotypes** that could be analysed across groups,  available [here](https://docs.google.com/document/d/1okamrqYmJfa35ClLvCt_vEe4PkvrTwggHq7T3jbeyCI/edit?usp=sharing).
* We have drafted an **analysis plan** available [here](https://docs.google.com/document/d/16ethjgi4MzlQeO0KAW_yDYyUHdB9kKbtfuGW4XYVKQg/edit).
* **Meta-analysis results** are made available as soon as generated on the website [here](https://www.covid19hg.org/results/).
* **In-silico follow-up results** are  generated by the cummunity and made available [here](https://www.covid19hg.org/blog/2020-06-29-in-silico-follow-up-results/).
...
### Terms of use of results and authorship {#terms-of-use}

Accelerating discovery, results from meta-analyses generated by the COVID-19 Host Genetics Initiative are [made public immediately](https://www.covid19hg.org/results/) for the benefit of the wider biomedical community to advance discovery. Data and results may not be used in attempts to identify individual study participants

We envision two main scenarios for the use of the meta-analyses data with different suggested authorship guidelines.

* Groups using the results as a jumping-off point or supportive evidence for functional studies or in silico analyses are encouraged to acknowledge COVID-19 HGI but are not required to include authorship unless they feel the contribution warranted it. Per the traditional [Ft. Lauderdale rules](https://www.genome.gov/Pages/Research/WellcomeReport0303.pdf) of immediate genome data release, groups should not report the full genome scan results from the initiative (e.g. manhattan plots) in their analyses.
* Groups conducting analyses that might overlap with the core discovery efforts of the consortium are encouraged to contact us and join, rather than compete, with these efforts to accelerate discovery. For example, if a research group aims to perform and publish larger genome-wide discovery analyses including pre-publication summary statistics released by COVID-19 HGI, we would request that such groups contact us in advance to discuss fair authorship considerations which respect the many groups that have shared data to perform such analyses together and with immediate public release. We will advocate for including the list of people included in the [acknowledgment page](https://www.covid19hg.org/acknowledgements/) as co-authors.
...
### Support for genotyping and sequencing {#genotyping-sequencing-support}
