...
We have worked on the definition of a set of key initial phenotypes that could be analysed across groups,  available [here](https://docs.google.com/document/d/1eMdzhO5xk-MACxjz-kOUJLP6Jort5KuwoOa_u-aZPHs/edit?usp=sharing).
...
- **Helix** can perform discounted Exome+ (clinical grade exome + genotyping backbone equivalent to GSA) sequencing for any COVID-19 samples where the data will be made rapidly available. Contact: Liz Cirulli, liz.cirulli@helix.com
