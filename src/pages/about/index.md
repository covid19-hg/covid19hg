...
Accelerating discovery, results from meta-analyses generated by the COVID-19 Host Genetics Initiative are [made public immediately](https://www.covid19hg.org/results/) for the benefit of the wider biomedical community to advance discovery.

We envision two main scenarios for the use of the meta-analyses data with different suggested authorship guidelines.

* Groups using the results as a jumping-off point or supportive evidence for functional studies or in silico analyses are encouraged to acknowledge COVID-19 HGI but are not required to include authorship unless they feel the contribution warranted it.
