...
import {partnersRoute, getSelectedPartner, setSelectedPartner} from "../components/partnersPageUtils";
...
const ProductPage = ({ data, location }) => {
  ...
  return (
    <Layout title="Partners">
      ...
      <PartnersPageContent selectedPartner={selectedPartner} setSelectedPartner={setSelectedPartner}/>
    </Layout>
  );
};
