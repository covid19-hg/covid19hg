...
import Map, { SET_SELECTED_INSTITUTION_ACTION, UNSET_SELECTED_INSTITUTION_ACTION } from '../components/Map'
...
const ProductPage = ({ data }) => {
  ...
  return (
    <Layout>
      ...
      <ProductPageTemplate image={frontmatter.image} title={frontmatter.title} />
    </Layout>
  )
}
